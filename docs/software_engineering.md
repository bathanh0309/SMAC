# SMAC - Tài liệu Công nghệ Phần mềm
...
2. [Yêu cầu chức năng (Functional Requirements)](#2-yêu-cầu-chức-năng-functional-requirements)
3. [Yêu cầu phi chức năng (Non-functional Requirements)](#3-yêu-cầu-phi-chức-năng-non-functional-requirements)
4. [Phân tích phương pháp phát triển](#4-phân-tích-phương-pháp-phát-triển)
5. [Đề xuất phương pháp phù hợp](#5-đề-xuất-phương-pháp-phù-hợp)
...
#### Use Case: UC-01 - Phát hiện và mở cổng tự động

| Thành phần | Mô tả |
|------------|-------|
| **Actor** | Camera, Hệ thống |
| **Precondition** | Hệ thống đang chạy, camera kết nối |
| **Main Flow** | 1. Camera capture frame<br>2. YOLO phát hiện người (conf ≥ 0.7)<br>3. Timer bắt đầu đếm<br>4. Sau 10s → Mở cổng<br>5. Gửi Telegram alert<br>6. Lưu log vào DB |
| **Alternative Flow** | 3a. Người biến mất → Reset timer |
| **Postcondition** | Cổng mở, log được lưu |
...
## 4. Phân tích phương pháp phát triển

### 4.1 So sánh Waterfall vs Scrum
...
### 4.2 Phân tích Waterfall cho SMAC
...
### 5.2 Kế hoạch triển khai đề xuất

```
╔════════════════════════════════════════════════════════════════╗
║                    SMAC Development Plan                        ║
╠════════════════════════════════════════════════════════════════╣
║                                                                  ║
║  Phase 1: Requirements & Design (Waterfall)                     ║
║  ─────────────────────────────────────────                      ║
║  • Week 1: SRS, Use Cases, Diagrams                             ║
║  • Deliverables: All UML diagrams, requirements doc             ║
║                                                                  ║
║  Phase 2: Implementation (Iterative)                            ║
║  ─────────────────────────────────────                          ║
║  • Week 2-3: Core modules (detection, gate)                     ║
║  • Week 4: Integration (telegram, database)                     ║
║  • Week 5: Frontend (web dashboard)                             ║
║  • Daily standup / weekly demo                                  ║
║                                                                  ║
║  Phase 3: Testing & Deployment (Waterfall)                      ║
║  ─────────────────────────────────────────                      ║
║  • Week 6: Testing, bug fixes, documentation                    ║
║  • Deliverables: Test report, user manual, demo                 ║
║                                                                  ║
╚════════════════════════════════════════════════════════════════╝
```

### 5.3 Artifacts cần nộp cho môn học

| Artifact | Mô tả | Status |
|----------|-------|--------|
| SRS Document | Yêu cầu chức năng & phi chức năng | ✅ (file này) |
| Use Case Diagram | Sơ đồ ca sử dụng | ✅ Created |
| Class Diagram | Sơ đồ lớp | ✅ Created |
| Sequence Diagram | Sơ đồ tuần tự | ✅ Created |
| State Diagram | Sơ đồ trạng thái | ✅ Created |
| Activity Diagram | Sơ đồ hoạt động | ✅ Created |
| Source Code | GitHub repository | ✅ Available |
| README | Hướng dẫn sử dụng | ✅ Available |
| Demo Video | Video demo hệ thống | Cần tạo |
| Test Report | Báo cáo kiểm thử | Cần tạo |
...
*Tài liệu được tạo cho môn Công nghệ Phần mềm*  
*Dự án: SMAC - Security Monitoring Access Control*  
*Ngày tạo: 03/01/2026*
